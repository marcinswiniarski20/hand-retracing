...
def detect(save_txt=False, save_img=False, stream_img=False):
    ...
    for path, img, im0, vid_cap in dataset:
        ...
        if opt.one_hand and det is not None and det.shape[0] > 1:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/ego.data', help='coco.data file path')
    ...
    parser.add_argument('--one-hand', action='store_true', default=False, help='detect only one hand with the best prediction', dest='one_hand')
