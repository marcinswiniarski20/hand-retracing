...
19 Def Pos temp
20 '
21 Def Char WorkMode
22 Def Char ReceivedData
23 ' ---------------------------------------------
24 '
25 '
26 '
...
74     Command% = Val(Left$(ReceivedData$, 1))
75     Com Stop
76     Select Command%
77         Case 1
...
123         Ypos% = Val(Mid$(ReceivedData$, 4, 5))
...
184     C_Com(2) = "ETH:192.168.43.56, 10002"
...
GoalPosition=(+600.00,-0.00,+650.00,-178.36,+2.72,+85.61)(7,0)
temp=(+600.00,-238.00,+509.00,-178.36,+2.72,+85.61)(7,0)
