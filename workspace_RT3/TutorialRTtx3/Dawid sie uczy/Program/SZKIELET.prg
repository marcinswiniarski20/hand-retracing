...
48     P1 = Phome
49     P2 = Phome
50     P1 = SetPos(Phome.X - 20,  Phome.Y - 300, Phome.Z - 300)
51     P2 = SetPos(Phome.X + 20,  Phome.Y + 300, Phome.Z + 250)
52     IsConnected% = 0
...
122         If Zone(GoalPosition, P1, P2) Then
123             Mov GoalPosition
124             Dly 0.1
125             Print #1, "Moving to the point in zone."
126         Else
...
180     C_Com(2) = "ETH:192.168.0.7, 10002"
...
224     End
225 ' ---------------------------------------------
P1=(+579.83,-300.00,+656.11,-178.36,+2.72,+85.61)(7,0)
P2=(+619.83,+300.00,+1206.11,-178.36,+2.72,+85.61)(7,0)
GoalPosition=(+599.83,+291.00,+752.00,-178.36,+2.72,+85.61)(7,0)
temp=(+599.83,+291.00,+752.00,-178.36,+2.72,+85.61)(7,0)
Phome=(+599.83,+0.00,+956.11,-178.36,+2.72,+85.61)(7,0)
